...
struct VariableResolverPass : ASTPass<void,ThingOfCode>
{
  ...
  void VisitNode(ConstantNode<unsigned int>* node , ThingOfCode* code);
  void VisitNode(ConstantNode<int>* node          , ThingOfCode* code);
  void VisitNode(ConstantNode<float>* node        , ThingOfCode* code);
  void VisitNode(ConstantNode<bool>* node         , ThingOfCode* code);
